...
ios: clean
	xcrun safari-web-extension-converter . --project-location safari-extension --force 

create-without-open: clean
	xcrun safari-web-extension-converter . --project-location safari-extension --force --no-open
